...
combine_datasets <- function(results1, results2){
  combined_county <- dplyr::bind_rows(as.data.frame(results1[[1]]),as.data.frame(results2[[1]]))
  combined_state <- dplyr::bind_rows(as.data.frame(results1[[2]]),as.data.frame(results2[[2]]))
