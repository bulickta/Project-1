...
# I suppressed warnings and messages because they were happening for reading in CSV's even when nothing was wrong -EN
...
plot.county <- function(df,state_choice="NC",top_bottom="top",n_given=5,var_name="enrollment"){
  ...
  ### i was able to get ifelse() below - EN
...
plot.county(finalCombo[[1]],state_choice="NC",top_bottom="top",n_given=20)
plot.county(finalCombo[[1]],state_choice="SC",top_bottom="bottom",n_given=7)
plot.county(finalCombo[[1]])
plot.county(finalCombo[[1]],state_choice="PA",top_bottom="top",n_given=8)

# I believe the default var name for these 4 is also 'enrollment', but not 100% sure -EN
...
plot.state(combine3[[2]])
plot.county(combine3[[1]], "CA", "top", 15)
plot.county(combine3[[1]], "TX", "top", 4)
plot.county(combine3[[1]])
plot.county(combine3[[1]], "NY", "top", 10)
